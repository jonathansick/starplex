"""Schema helpers for SQLAlchemy, making ORM table declarations easier.

This module is based on an example project presented by Mike Bayer at
...
# Note: to use this code, change base to declare the base as
